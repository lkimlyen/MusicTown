...
public class VideoLocalFragment extends BaseFragment implements VideoLocalContract.View {
    private final String TAG = VideoLocalFragment.class.getName();
    private VideoLocalContract.Presenter mPresenter;
    ...
    @Override
    public void setPresenter(VideoLocalContract.Presenter presenter) {
